...
#
# Sample code to generate q nums for spraying mode (virtual q mode in xp80_A0)
#
    ...
    for mc in range(pow(2, mc_bits)):
        ...
        for i in range(pow(2, dp_bits)):
            ...
            for tc in range(pow(2, tc_bits)):
                ...
                ent_idx = mc << 14   # mc bit is bit 14 in index
                ent_idx |= i << 6    # dest_port is located in bits 6-13
        
                ent_idx |= (tc << 2)    # we now have the line
